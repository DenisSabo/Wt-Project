...
<nav class="sidebar collapse white animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
    <div class="container">
        ...
        <img src="https://w3schools.com/w3images/avatar_g2.jpg" style="width:45%;" class="round"><br><br>
        <h4><b>PORTFOLIO</b></h4>
    </div>
    <div class="bar-block">
        <a href="#portfolio" onclick="wt_close()" class="bar-item button padding text-teal"><i class="fa fa-th-large fa-fw margin-right"></i>PORTFOLIO</a>
        <a href="#about" onclick="wt_close()" class="bar-item button padding"><i class="fa fa-user fa-fw margin-right"></i>ABOUT</a>
        <a href="#contact" onclick="wt_close()" class="bar-item button padding"><i class="fa fa-envelope fa-fw margin-right"></i>CONTACT</a>
    </div>
...
<div class="main" style="margin-left:300px">
    ...
    <!-- Form for uploading images. Currently no css for this form implemented --> 
    <form id="imageUploadForm" method="POST" enctype="multipart/form-data">

    <label for="title"> Title of image </label>
    <input type="text" name="title" id="title" placeholder="Christmas with family ..." required>

    <label for="description"> Describe your image briefly. </label>
    <input type="text" name="description"  id="description" placeholder="Best cook on earth: Mom">

    <!-- Hint should be hidden. If clicked on icon: show hint -->
    <label for="tags"> Define tags that will improve search results for your image! Hint: Words with whitespace inbetween, will be treated as different tags. For example: 
    You write: 'Family Christmas Love', Tag 1: Family, Tag 2: Christmas, Tag 3: Love</label>
    ...
    <input type="text" name="categories" id="categories" placeholder="Category1 Category2 ...">

    <label for="pic"> Search for an image on your computer </label>  
    <input type="file" name="pic" id="pic" accept="image/png|image/jpg|image/jpeg|image/gif">

    <input type="submit" id="uploadImage" value="Upload Image"></input>
  </form>
    ...
    <!-- Images of Me -->
    <div class="row-padding padding-16" id="about">
        <div class="col m6">
            <img src="https://w3schools.com/w3images/avatar_g.jpg" alt="Me" style="width:100%">
        </div>
        <div class="col m6">
            <img src="https://w3schools.com/w3images/me2.jpg" alt="Me" style="width:100%">
        </div>
    </div>
